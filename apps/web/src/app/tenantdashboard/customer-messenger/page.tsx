    ...
    <div className="min-h-screen bg-slate-50 dark:bg-black pb-20 lg:pb-0">
      <div className="max-w-[1400px] mx-auto px-4 sm:px-6 lg:px-10 py-4 sm:py-6 lg:py-10 h-[calc(100vh-5rem)] flex flex-col">
        ...
        <div className="flex-1 bg-white dark:bg-zinc-900 rounded-2xl sm:rounded-[2rem] shadow-sm border border-slate-100 dark:border-white/5 flex overflow-hidden relative">
                ...
                return (
                  ...
                  >
                    <div className="flex justify-between items-start mb-1">
                      <h4
                        className={`text-xs lg:text-sm font-bold flex items-center gap-1 text-charcoal dark:text-white`}
                      >
                    ...
                    <div className="flex items-center gap-2 mb-1 lg:mb-2">
                      <span
                        className={`text-[8px] lg:text-[9px] font-bold uppercase tracking-widest px-2 py-0.5 rounded-md bg-slate-100 text-slate-500 dark:bg-zinc-800`}
                      >
                        Public
                      </span>
                    </div>
          ...
          <div
            className={`${activeChat ? "flex" : "hidden lg:flex"} flex-1 flex-col bg-white dark:bg-zinc-950`}
          >
            {!activeChat ? (
                ...
                <div className="h-14 lg:h-16 border-b border-slate-100 dark:border-white/5 flex items-center justify-between px-4 lg:px-6 shadow-sm z-10 shrink-0">
                  ...
                  <div className="flex items-center gap-2">
                    <button className="flex items-center gap-1.5 lg:gap-2 px-2.5 lg:px-3 py-1.5 bg-red-50 text-primary hover:bg-primary hover:text-white rounded-lg text-[10px] lg:text-xs font-bold transition-all border border-red-100 dark:bg-red-900/10 dark:hover:bg-primary shadow-sm">
                      <Ban size={12} className="lg:w-[14px] lg:h-[14px]" />{" "}
                ...
                <div className="flex-1 overflow-y-auto p-4 lg:p-8 space-y-4 lg:space-y-6 bg-slate-50/30 dark:bg-black/20">
                  {messages.map((msg: any) => {
                    ...
                    return (
                      <div
                        key={msg.id}
                        className={`flex flex-col ${isTenant ? "items-end" : "items-start"} animate-fade-in`}
                      >
                        <div
                          className={`max-w-[85%] lg:max-w-[70%] border rounded-2xl px-4 py-2.5 lg:px-5 lg:py-3 shadow-sm ${
                            isTenant
                ...
                <div className="p-3 lg:p-5 border-t border-slate-100 dark:border-white/5 bg-white dark:bg-zinc-900 shrink-0">
                  ...
                  >
                    ...
                    <button
                      ...
                      className="p-2 lg:p-2.5 bg-primary text-white rounded-lg hover:bg-primary-hover transition-colors shadow-sm disabled:opacity-50"
                    >
                ...
                <div className="space-y-6">
                  ...
                  <div className="bg-white dark:bg-zinc-800 p-5 rounded-2xl border border-slate-200 dark:border-white/10 shadow-sm flex flex-col items-center text-center">
                    <div className="w-16 h-16 rounded-full bg-blue-50 dark:bg-blue-900/30 text-blue-500 font-bold text-2xl flex items-center justify-center mb-3">
                      {activeChat.user.name?.charAt(0) ||
                        activeChat.user.email?.charAt(0) ||
                        "?"}
                    </div>
                  ...
                  <div className="bg-white dark:bg-zinc-800 p-5 rounded-2xl border border-slate-200 dark:border-white/10 shadow-sm">
                    ...
                    <p className="text-xs font-medium text-slate-500 mb-4">
                      Please respond to inquiries promptly. Quick replies boost
                      the shop reliability score on the public page.
                    </p>
                  </div>
                </div>
              </div>
