      ...
      <div className="px-4 sm:px-6 lg:px-8 h-16 sm:h-20 flex items-center justify-between">
          ...
          <Link href="/tenantdashboard">
            <div className="flex items-center gap-2 sm:gap-3 cursor-pointer">
              ...
              <div className="hidden sm:flex flex-col whitespace-nowrap">
                <h1 className="text-charcoal dark:text-white font-black text-base lg:text-lg tracking-tighter leading-none mb-0.5 mt-0.5">SR-MANAGE</h1>
                <span className="text-[9px] lg:text-[10px] text-primary font-black uppercase tracking-[0.2em] leading-none">Tenant Portal</span>
              </div>
            </div>
          </Link>
        ...
        <div className="flex items-center gap-1 sm:gap-3">
          ...
          <button className="relative p-2 text-slate-400 hover:text-primary transition-colors hidden sm:block">
            <Bell size={20} />
            <span className="absolute top-1 right-1 w-2 h-2 bg-primary rounded-full border-2 border-white dark:border-black"></span>
          </button>
          ...
          <div className="relative">
            ...
            >
              ...
              <div className="flex-col items-start leading-none hidden md:flex">
                <span className="text-xs font-bold text-charcoal dark:text-white">{user?.name?.split(' ')[0] || 'Tenant'}</span>
                <span className="text-[9px] text-slate-400 font-medium tracking-tight">Account</span>
              </div>
